...
<?=$__view_header?>
    ...
    <body>
        ...
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="<?=$_base?>/">
                <img src="<?=$_base?>/img/north-dte-logo.svg" alt="NorthDTE" class="brand-logo" />
        ...
        <footer class="footer d-print-none">
            <div class="container">
                <div class="float-start">
                    &copy; <?=date('Y')?> NorthDTE -
                    <a href="<?=url('/consultar')?>" title="Consultar documentos (incluyendo boletas)">Consultar DTE</a><br/>
                    <span class="small">
                        Aplicación de facturación basada en <a href="https://www.libredte.cl">NorthDTE</a>
